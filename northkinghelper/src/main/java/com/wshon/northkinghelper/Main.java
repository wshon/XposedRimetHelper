package com.wshon.northkinghelper;
...
import com.wshon.northkinghelper.hook.LocationHook;
...
public class Main implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        ...
        final String RIMET_PACKAGENAME = "com.northking.dayrecord";
        if (BuildConfig.APPLICATION_ID.equals(lpparam.packageName)) {
            XposedHelpers.findAndHookMethod("MainActivity", lpparam.classLoader,
